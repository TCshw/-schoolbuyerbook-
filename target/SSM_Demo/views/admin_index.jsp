...
<rapid:override name="content">
    ...
    <div style="width:600px; height:450px; margin:100px 350px; border:3px solid gray;">
        <h2 style="text-align: center; margin-top: 25px; margin-bottom: 25px;">教材订购系统（教材发行人员）</h2>
        <h3 style="margin-left:50px; margin-bottom: 10px;">1.登陆后请及时修改初始密码（个人资料）</h3>
        <h3 style="margin-left:50px; margin-bottom: 10px;">2.可查看订购书籍，查看库存，确定订购状态，制作缺书单</h3>
    </div>
</rapid:override>
