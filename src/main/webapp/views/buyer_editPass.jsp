...
<rapid:override name="content">
    ...
    <button type="button"  id="buyerpass" class="layui-btn layui-btn-danger layui-btn-lg" style="margin:0 550px;">
        确认修改
    </button>
            ...
            $("#buyerpass").click(function () {
                ...
                if(now == again) {
                    $.ajax({
                        ...
                        type: "post",
                        url: "<%=basePath%>buyer/changebuyerPass",
                        data: data,
                        // $("#stupassform").submit();
                        // dataType:"post",
                        success: function (data) {
                            if (data == 1) {
                                ...
                                window.location.href = "<%=basePath%>views/buyer_info.jsp";
                            } else if (data == 0) {
                                //反之进行弹框提示   登录失败
                                window.location.href = "<%=basePath%>views/buyer_editPass.jsp";
                                //如果账户错误则清空账户
